                ...
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="flex gap-4">
                            <a href="https://wa.me/12497557581" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-brand-green transition-colors" title="WhatsApp Suporte">{ICONS.whatsapp}</a>
